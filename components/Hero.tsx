  ...
  return (
    <section className="p-6">
      <div className="lg:grid lg:grid-cols-2 lg:gap-8">
        <div className="mb-8 lg:mb-0 flex flex-col justify-center items-start gap-6 md:items-center lg:items-start">
          <h1 className="text-5xl font-medium md:text-7xl md:text-center md:max-w-[800px] lg:text-left">
            Change the way you manage your{" "}
            <span className="font-serif text-green-700">money</span>
          </h1>
          <p className="text-gray-600 font-medium md:text-center md:max-w-[600px] lg:text-left">
